...
| S3 media                             | `apps/web/amplify/storage` defines a coarse report-media bucket access rule. Presigned upload is in place (CRIS-17, ADR-0035): the `createMediaUploadUrl` mutation mints a short-lived upload URL keyed by `clientRequestId`, and both clients upload before `submitReport` and pass the resulting `mediaKeys`. Quarantine/AV scanning, stricter per-object ownership, and signed delivery are still deferred.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
