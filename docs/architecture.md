...
| React SPA client (web)               | `apps/web` — landing + coordinator dashboard shell at `/coordinator` (CRIS-12 ✓, ADR-0022) and `/report` web fallback (CRIS-6, ADR-0021); map surface per CRIS-13. Routing via React Router (ADR-0021); auth-gating per CRIS-7 |
