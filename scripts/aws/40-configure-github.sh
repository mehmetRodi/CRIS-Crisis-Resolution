...
warn "AWS_DEPLOY_ENABLED=true means merges to main now deploy. In Settings → Environments,"
warn "configure 'production' to allow deployments from main only; reviewers are optional."
