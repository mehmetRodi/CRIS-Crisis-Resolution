...
warn "AWS_DEPLOY_ENABLED=true means merges to main now deploy. AWS also pins the OIDC trust"
warn "to this repository's exact main ref; do not add an environment: key to the deploy job."
